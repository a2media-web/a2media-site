  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        description:
          "Dedicated video team on a 3 to 6-month engagement. 10 to 12 done-for-you videos per month, 72-hour turnaround, and ongoing strategy. Rates from $15K to $23K per month based on engagement length.",
        price: "90000",
        priceCurrency: "USD",
