...
/* Variant 1 — Cards stay big.
 *  Phases: Without Video → With Video + 3 cards → cards translate UP only
 *  (no scale, no restyle) → they anchor at top of section as a 3-up summary
 *  header. Below them, the active study panel renders. Cards stay clickable
 *  and continue showing their hero number.
 */

import { useEffect, useRef, useState } from "react";
import { STUDIES, TICKER, range } from "../StoryScroll/_shared";
import styles from "./StoryScrollV1.module.css";

export default function StoryScrollV1() {
  ...
  // Cards translate up but DO NOT scale or restyle.
  const liftProgress = range(progress, 0.65, 0.9);
    ...
    <section className={styles.section}>
        ...
        <div className={styles.morphSticky}>
          ...
          >
            ...
            <div
              ...
              style={{
                transform: `translateY(${-liftProgress * 18}vh)`,
              }}
            >
              {STUDIES.map((s, i) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      opacity: cardOpacity,
                      pointerEvents: liftProgress > 0.4 ? "auto" : "none",
                      cursor: liftProgress > 0.4 ? "pointer" : "default",
                    }}
                    onClick={() => liftProgress > 0.4 && setActiveId(s.id)}
                    aria-label={s.name}
                  >
                    ...
                    <div
                      ...
                      style={{
                        opacity: isActive && liftProgress > 0.6 ? 1 : 0,
                      }}
                      aria-hidden
                    />
                  </button>
      ...
      <div className={styles.panelArea}>
        <div className={styles.panelInner}>
          ...
          {/* Same 3 big cards as the "tab nav" — full size, full content */}
