...
/* C-2-3 — Side Rail Cards.
 * Two-column layout: 3 cards stacked vertically on the left as a sticky
 * sidebar; panel content scrolls on the right. Active card highlighted.
 * Click any card → right panel switches.
 */

import { useEffect, useRef, useState } from "react";
import { STUDIES, TICKER, range } from "../StoryScroll/_shared";
import styles from "./SideRailCards.module.css";

export default function SideRailCards() {
      ...
      <div className={styles.panelArea}>
        <div className={styles.panelInner}>
          ...
          <div className={styles.layout}>
            <aside className={styles.rail} role="tablist">
              {STUDIES.map((s) => {
