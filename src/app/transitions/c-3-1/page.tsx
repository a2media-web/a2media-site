    ...
    <>
      <header style={hdr}>
        ...
        <div style={{ marginTop: 12 }}>
          <span style={tag}>C-3-1</span>
        </div>
        <h1 style={title}>Sticky Curtain</h1>
        <p style={sub}>
          Cards rendered ONCE in panel area with <code>position: sticky; top: 100px</code>.
          They rise into view as panel enters viewport, then PIN as panel
          content scrolls beneath. Cards never disappear. Click any to switch.
        </p>
      </header>
      <StickyCurtain />
    </>
