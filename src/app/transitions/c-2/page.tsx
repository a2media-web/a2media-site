import StoryScrollV2 from "@/components/sections/StoryScrollV2";
  ...
  return (
    <>
      <header style={hdr}>
        ...
        <h1 style={title}>Active Card Expands</h1>
        <p style={sub}>
          During the morph, the active card grows wider (using CSS grid +
          :has selector) while the other 2 compress to slimmer cards. Click
          any inactive card to swap. Below: the panel for whichever card is
          active.
        </p>
      </header>
      <StoryScrollV2 />
