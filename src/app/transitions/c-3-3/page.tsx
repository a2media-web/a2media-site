import ReadingSentinel from "@/components/sections/ReadingSentinel";
...
export default function Page() {
  return (
    <>
      <header style={hdr}>
        <Link href="/transitions/c-3-1" style={navLink}>→ C-3-1</Link>
        <Link href="/transitions/c-3-2" style={navLink}>→ C-3-2</Link>
        <div style={{ marginTop: 12 }}>
          <span style={tag}>C-3-3</span>
        </div>
        <h1 style={title}>Reading Sentinel</h1>
        <p style={sub}>
          Cards pinned at top of section. All 3 panels render below in a
          vertical stack. As you scroll through Reveal panel, Reveal card
          highlights; same for Auth0 and PartnerHacker. IntersectionObserver
          drives the active state — cards become a &quot;you are here&quot;
          reading indicator. Click any to jump.
        </p>
      </header>
      <ReadingSentinel />
    </>
