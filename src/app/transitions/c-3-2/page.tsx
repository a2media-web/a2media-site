import CurtainLift from "@/components/sections/CurtainLift";
  ...
  return (
    <>
      <header style={hdr}>
        ...
        <Link href="/transitions/c-3-3" style={navLink}>→ C-3-3</Link>
        <div style={{ marginTop: 12 }}>
          <span style={tag}>C-3-2</span>
        </div>
        <h1 style={title}>Curtain Lift</h1>
        <p style={sub}>
          Cards rise from center of viewport during success state, lift up
          smoothly to top:100px via <code>position: fixed</code>, then hand
          off to <code>position: sticky</code> when panel area arrives.
          ONE set of cards, smooth continuous curtain motion.
        </p>
      </header>
      <CurtainLift />
    </>
