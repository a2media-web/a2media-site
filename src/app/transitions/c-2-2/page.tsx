    ...
    <>
      <header style={hdr}>
        ...
        <div style={{ marginTop: 12 }}>
          <span style={tag}>Idea 2</span>
        </div>
        <h1 style={title}>Accordion Below Cards</h1>
        <p style={sub}>
          3 cards stay in a row. Click any card → panel content expands
          beneath it (with a small purple connector line). Click another →
          previous collapses, new one opens. Cards never move.
        </p>
      </header>
      <AccordionCards />
    </>
